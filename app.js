...
var getWeather = function() {
  ...
  function showWeather(lat, long) {
    var url = `https://api.darksky.net/forecast/b35948fd54151ecef5ac1b022be87a9c/${lat},${long}` + `?format=jsonp&callback=displayWeather`;
...
var object;
 ...
 function displayWeather(object) {
    ...
    uvIndex.innerHTML = "uv Index: " + object.currently.uvIndex;
